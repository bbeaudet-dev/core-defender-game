...
export const DEFAULT_PUZZLES: Record<string, PuzzleConfig> = {
  ...
  'clock_sync': {
    ...
    description: 'Synchronize the device clock with network time',
    moduleId: 'clock',
    targetAction: 'sync_time',
    isComplete: false,
    color: 'cyan',
  },
  'games_play': {
    ...
    description: 'Complete a mini-game to test cognitive functions',
    moduleId: 'games',
    targetAction: 'complete_game',
    isComplete: false,
    color: 'purple',
  },
  'wifi_connect': {
    ...
    description: 'Establish a WiFi connection to restore network access',
    moduleId: 'wifi',
    targetAction: 'connect_wifi',
    isComplete: false,
    color: 'blue',
  },
  'weather_check': {
    id: 'weather_check',
    name: 'Weather Data',
    description: 'Retrieve weather information to test location services',
    moduleId: 'weather',
