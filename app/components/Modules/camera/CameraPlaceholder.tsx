  ...
  return (
    <View className="bg-gray-800 rounded-lg p-4 mb-4">
      <View className="bg-gray-700 rounded-lg p-8 items-center justify-center">
        ...
        <Text style={{ fontFamily: FONTS.MONO }} className="text-gray-400 text-center text-sm">Camera View</Text>
        <Text style={{ fontFamily: FONTS.MONO }} className="text-gray-500 text-center text-xs mt-1">Placeholder</Text>
        ...
        {onPhotoCapture && (
          ...
          >
            <Text style={{ fontFamily: FONTS.MONO }} className="text-white text-center text-sm">
              CAPTURE PHOTO
            </Text>
          </TouchableOpacity>
        )}
